...
export const projects: Project[] = [
  ...
  { slug: 'buggy-and-cenote', name: 'BuggyAndCenote.com', url: 'https://www.buggyandcenote.com', image: '/projects/buggy-and-cenote.png', category: 'E-commerce turístico + reservas', summary: 'Producto vertical multilingüe para reservar buggies, cenote y Playa Macao, con precios por vehículo, grupos de hasta 120 personas, pagos online y asistencia operativa conectada a Telegram.' },
