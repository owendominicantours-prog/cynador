...
export const metadata: Metadata = {
  ...
  description: 'Cómo Cynador construyó para Proactivitis una plataforma turística, una app Android, reservas y más de 60,000 URLs indexadas que generan ventas orgánicas.',
  alternates: { canonical: '/casos/proactivitis' },
};

export default function ProactivitisCasePage() {
  const project = projects[0];
  const jsonLd = { '@context': 'https://schema.org', '@type': 'Article', headline: 'Caso Proactivitis: de operación turística a ecosistema digital', author: { '@type': 'Organization', name: 'Cynador' }, about: ['SEO programático', 'Desarrollo web', 'Aplicación Android', 'Reservas turísticas'], mentions: { '@type': 'MobileApplication', name: 'Proactivitis', operatingSystem: 'Android', applicationCategory: 'TravelApplication', url: proactivitisPlayStore } };
  return (
